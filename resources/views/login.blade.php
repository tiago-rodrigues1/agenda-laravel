                        ...
                        <div class="card-body">
                            <div id="login" class="tab">
                                <form action="/usuario/login" method="post">
                                    ...
                                    <small style="margin-left: 10px;">Não tenho cadastro. <a href="#" class="change" data-target="#cadastro">Cadastrar-me</a></small>
                                </form>
                            </div>
                            <div id="cadastro" class="tab" style="display: none;">
                                <form action="/usuario/cadastrar" method="post">
                                    ...
                                    <small style="margin-left: 10px;"><a href="#" class="change" data-target="#login">Voltar para login</a></small>
                                </form>
                            </div>
                        </div>
                    </div>
